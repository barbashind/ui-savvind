...
const AccountingDetailsModalMobile = ({isOpen, setIsOpen, id, setId,  setUpdateFlag} : TAccountingDetailsModalProps) => {
                        ...
                        <Layout direction="column" style={{width: '100%'}} className={cnMixSpace({ p:'xl' })}>
                                ...
                                <Layout direction="column" className={cnMixSpace({mT:'m'})}>
                                        <Layout direction="row" className={cnMixSpace({mT:'s'})} style={{alignItems: 'center'}}>
                                                <Text size="s" style={{maxWidth: '150px', minWidth: '150px'}} className={cnMixSpace({mR:'m'})}>Счет списания</Text>
                                                <Combobox
                                                        items={accounts}
                                        ...
                                        <Layout direction="row" className={cnMixSpace({mT:'s'})} style={{alignItems: 'center'}}>
                                                <Text size="s" style={{maxWidth: '150px', minWidth: '150px'}} className={cnMixSpace({mR:'m'})}>Счет пополнения</Text>
                                                <Combobox
                                                        items={accounts}
                                                        getItemLabel={(item)=> (item.name ?? '')}
                                                        getItemKey={(item) => (item.accountId ?? 0)}
                                        ...
                                        <Layout direction="row" className={cnMixSpace({mT:'s'})} style={{alignItems: 'center'}}>
                                                <Text size="s" style={{maxWidth: '150px', minWidth: '150px'}} className={cnMixSpace({mR:'m'})}>Обоснование</Text>
                                                <TextField 
                                        ...
                                        <Layout direction="row" className={cnMixSpace({mT:'s'})} style={{alignItems: 'center'}}>
                                        <Text size="s" style={{minWidth: '150px', maxWidth: '150px'}} className={cnMixSpace({mR:'m'})}>Категория</Text>
                                        <Combobox
                                                items={categories}
                                                getItemLabel={(item)=> (item.name ?? '')}
                                ...
                                <Layout direction="row" style={{justifyContent: 'center', alignItems: 'end'}}  flex={1} className={cnMixSpace({ mT:'s' })}>
                                        <Layout direction="row" style={{justifyContent: 'center'}} className={cnMixSpace({ mT:'s' })}>
                                                ...
                                                <Button 
                                                        ...
                                                        view="primary"
                                                        size="s"
                                                        disabled={((data.accountFrom === data.accountTo && !!data.accountFrom) || (accounts.find(el => (el.name === data?.accountFrom))?.currency !== accounts.find(el => (el.name === data?.accountTo))?.currency && !!data.accountFrom && !!data.accountTo) || (!data.value)) || (!data.accountTo && !data.accountFrom)}
                                                        className={cnMixSpace({ mR:'m' })}
                                                        onClick={(e)=>{
                                                                if (data.id) {
...
export default AccountingDetailsModalMobile