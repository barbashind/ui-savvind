...
const NomenclatureDetailsModalMobile = ({isOpen, setIsOpen, id, setId,  setUpdateFlag} : TNomenclatureDetailsModalProps) => {
        ...
        return (
                ...
                >
                        ...
                        <Layout direction="column" style={{width: '100%'}} className={cnMixSpace({ p:'xl' })}>
                                ...
                                />
                                <Text size="s" className={cnMixSpace({ mT:'s' })}>Альтернативное наименование:</Text>
                                <TextField 
                                        size="s"
                                        type="textarea"
                                        maxRows={3}
                                        ...
                                        className={cnMixSpace({ mT:'2xs' })}
                                />
                                <Text size="s" className={cnMixSpace({ mT:'s' })}>Наименование для печати:</Text>
                                <TextField 
                                        size="s"
                                        type="textarea"
                                        maxRows={3}
                                ...
                                <Layout direction="column" flex={0.845} className={cnMixSpace({mT:'s'})}>
                                ...
                                <Layout direction="column">
                                <Layout direction="column">
                                                <Text size="s" className={cnMixSpace({ mT:'xs' })}>Цена:</Text>
                                                <NumberMaskTextField
                                                        size="s" 
...
export default NomenclatureDetailsModalMobile;